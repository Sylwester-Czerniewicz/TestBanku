...
WebUI.setText(findTestObject('Object Repository/pekaotr/PekaoTestKarty/input__parUsername'), (GlobalVariable.LOGIN))
WebUI.click(findTestObject('Object Repository/pekaotr/PekaoTestKarty/input__butLogin'))
WebUI.setText(findTestObject('Object Repository/pekaotr/PekaoTestKarty/Page_Pekao24  bankowo elektroniczna/input__f0'), (GlobalVariable.PASSWORD))
